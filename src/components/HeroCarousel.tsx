  ...
  return (
    <div className="relative h-screen overflow-hidden">
      <AnimatePresence mode="wait">
        ...
        >
          <div className="relative h-full bg-gradient-to-br from-primary-500 via-secondary-500 to-primary-600">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="bg-accent-500 hover:bg-accent-400 text-primary-600 px-8 py-4 rounded-full font-semibold text-lg transition-all duration-200 shadow-lg hover:shadow-xl"
                    >
      ...
      <button
        ...
        className="absolute left-4 top-1/2 -translate-y-1/2 z-20 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white p-3 rounded-full transition-all duration-200"
      >
        <ChevronLeft className="h-6 w-6" />
      </button>
      <button
        onClick={goToNext}
        className="absolute right-4 top-1/2 -translate-y-1/2 z-20 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white p-3 rounded-full transition-all duration-200"
      >
